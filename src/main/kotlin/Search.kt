...
fun searchCheck(title: String, filename: String, isNote1 : Boolean) : Boolean{
...
fun searchIfEmpty(filename: String, isNote1: Boolean):Boolean{
    var folderOrTxt : String
    var result2 : String
    var check = true
    var count : Int
