class ArchiveList {
    private val map: MutableMap<String, NoteList> = mutableMapOf() // map хранит список архивов, где String - имя архива, NoteList- список заметок
    var activeNoteList:NoteList=NoteList() // В activeNoteList хранится номер активированного архива
    ...
    // Создать архив
    val createArchive: (name:String) -> Unit = {
            name -> map[name] = NoteList()
